...
#     try:
#         driver.get("https://www.tiktok.com/login/phone-or-email/email")
#         sadcaptcha = SeleniumSolver(driver, os.environ["8db9aba3f3d66eb999280b6414125214"])
...
# #     try:
# #         open_tiktkok_login(driver)
# #         sadcaptcha = SeleniumSolver(driver, os.environ["8db9aba3f3d66eb999280b6414125214"], proxy=os.environ["PROXY"])
# #         sadcaptcha.solve_captcha_if_present()
# #     finally:
# #         driver.quit()
#
