...
def test_solve_at_scroll(caplog) -> None:
    ...
    with sync_playwright() as p:
        ...
        sadcaptcha = PlaywrightSolver(page, os.environ["8db9aba3f3d66eb999280b6414125214"])
...
#         stealth_sync(page, config)
#         open_tiktkok_login(page)
#         sadcaptcha = PlaywrightSolver(page, os.environ["8db9aba3f3d66eb999280b6414125214"], proxy=os.environ["PROXY"])
#         sadcaptcha.solve_captcha_if_present()
#         page.locator("css=#header-more-menu-icon").is_visible()
#         expect(page.locator("css=#header-more-menu-icon")).to_be_visible(timeout=30000)
#
